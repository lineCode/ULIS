                                  ...
                                  , const float        iOpacity )
{
    switch( iSource->Model() ) {
        ...
        case CM_GREY:   BlendMono_NonSeparable_CM_Grey_SSE4_2<     T >( iSource, iBackdrop, iSrcRoi, iDstRoi, iBlendingMode, iAlphaMode, iOpacity ); break;
        case CM_RGB:    BlendMono_NonSeparable_CM_RGB_SSE4_2<      T >( iSource, iBackdrop, iSrcRoi, iDstRoi, iBlendingMode, iAlphaMode, iOpacity ); break;
        case CM_CMYK:   BlendMono_NonSeparable_CM_CMYK_SSE4_2<     T >( iSource, iBackdrop, iSrcRoi, iDstRoi, iBlendingMode, iAlphaMode, iOpacity ); break;
        case CM_Lab:    BlendMono_NonSeparable_CM_Lab_SSE4_2<      T >( iSource, iBackdrop, iSrcRoi, iDstRoi, iBlendingMode, iAlphaMode, iOpacity ); break;
        default:        BlendMono_NonSeparable_CM_DEFAULT_SSE4_2<  T >( iSource, iBackdrop, iSrcRoi, iDstRoi, iBlendingMode, iAlphaMode, iOpacity ); break;
    }
}
