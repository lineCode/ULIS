...
*__________________
*
* @file         TransformPerspectiveMT_Bicubic_SSE_RGBA8.ipp
...
void
InvokeTransformPerspectiveMTProcessScanline_Bicubic_SSE_RGBA8( tByte* iDst, int32 iLine, std::shared_ptr< const _FTransformInfoPrivate > iInfo, const Vec4i iIDT ) {
    ...
    for( int x = 0; x < info.dst_roi.w; ++x ) {
        ...
        const Vec4f tx      = pointInSrc.x - src_x;
        const Vec4f ty      = pointInSrc.y - src_y;
...
void
TransformPerspectiveMT_Bicubic_SSE_RGBA8( std::shared_ptr< const _FTransformInfoPrivate > iInfo ) {
    const _FTransformInfoPrivate&   info        = *iInfo;
    ...
    ULIS3_MACRO_INLINE_PARALLEL_FOR( info.perfIntent, info.pool, info.blocking
                                   , info.dst_roi.h
                                   , InvokeTransformPerspectiveMTProcessScanline_Bicubic_SSE_RGBA8
