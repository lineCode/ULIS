...
/// @fn         void Clear( FThreadPool* iPool, FBlock* iDst, const FPerf& iPerf, bool iCallInvalidCB )
...
/// @fn         void Clear( FThreadPool* iPool, FBlock* iDst, const FRect& iRect, const FPerf& iPerf, bool iCallInvalidCB )
