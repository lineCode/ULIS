...
InvokeTransformBezierMTProcessScanline_Bicubic_MEM_Generic( uint8* iDst, int32 iLine, std::shared_ptr< const FTransformArgs > iInfo, std::shared_ptr< const FRasterImage2D > iField, std::shared_ptr< const FRasterImage2D > iMask ) {
...
template< typename T > void
TransformBezierMT_Bicubic_MEM_Generic( std::shared_ptr< const FTransformArgs > iInfo, std::shared_ptr< const FRasterImage2D > iField, std::shared_ptr< const FRasterImage2D > iMask ) {
    const FTransformArgs&   info        = *iInfo;
