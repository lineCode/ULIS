...
public:
    ...
    ULIS_MATRIX_FUNC TMatrix3x3();

    /*! Constructor from input diagonal value. */
    ULIS_MATRIX_FUNC TMatrix3x3( T iValue );
    ...
    /*! Copy constructor. */
    ULIS_MATRIX_FUNC TMatrix3x3( const TMatrix3x3& iOther );

    /*! Assignment operator from matrix. */
    ULIS_MATRIX_FUNC TMatrix3x3& operator=( const TMatrix3x3& iOther );
    ...
    template< typename U >
    ULIS_MATRIX_FUNC TMatrix3x3( const TMatrix3x3< U >& iOther );



    // Named Functions
    /*! Obtain the inverse of the matrix. */
    ULIS_MATRIX_FUNC TMatrix3x3 Inverse();

    /*! Obtain the transpose of the matrix. */
    ULIS_MATRIX_FUNC TMatrix3x3 Transpose();
    ...
    // Boolean operators
    /*! Equality operator. */
    ULIS_MATRIX_FUNC bool operator==( const TMatrix3x3& iOther );
    ...
    /*! Unary negative operator. */
    ULIS_MATRIX_FUNC TMatrix3x3 operator-() const;



    // Unary arithmetic operator with scalar
    /*! Unary addition operator with value. */
    ULIS_MATRIX_FUNC TMatrix3x3& operator+=( T iValue );
...
// Constructors
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T >::TMatrix3x3()
    : mCols {
          tColumn( 1, 0, 0 )
        , tColumn( 0, 1, 0 )
        , tColumn( 0, 0, 1 )
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T >::TMatrix3x3( T iValue )
    : mCols {
          tColumn( iValue, 0, 0 )
        , tColumn( 0, iValue, 0 )
        , tColumn( 0, 0, iValue )
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T >::TMatrix3x3( const TMatrix3x3< T >& iOther )
    : mCols {
          iOther.mCols[0]
        , iOther.mCols[1]
        , iOther.mCols[2]
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T >& TMatrix3x3< T >::operator=( const TMatrix3x3< T >& iOther ) {
...
template< typename T >
template< typename U >
ULIS_MATRIX_FUNC TMatrix3x3< T >::TMatrix3x3( const TMatrix3x3< U >& iOther )
    : mCols {
...
// Named Functions
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T > TMatrix3x3< T >::Inverse() {
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T > TMatrix3x3< T >::Transpose() {
    return  TMatrix3x3< T >(
          mCols[0][0]
        , mCols[1][0]
        , mCols[2][0]
...
template< typename T >
ULIS_MATRIX_FUNC T TMatrix3x3< T >::Determinant() {
...
// Boolean operators
template< typename T >
ULIS_MATRIX_FUNC bool TMatrix3x3< T >::operator==( const TMatrix3x3< T >& iOther ) {
...
// Unary Negative Operator
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T > TMatrix3x3< T >::operator-() const {
...
// Unary arithmetic operator with scalar
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T >& TMatrix3x3< T >::operator+=( T iValue ) {
    mCols[0] += iValue;
    mCols[1] += iValue;
    mCols[2] += iValue;
}
...
// Unary arithmetic operator with matrix
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T >& TMatrix3x3< T >::operator+=( const TMatrix3x3& iOther ) {
    mCols[0] += iOther.mCols[0];
    mCols[1] += iOther.mCols[1];
    mCols[2] += iOther.mCols[2];
}
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T > operator+( T iValue, const TMatrix3x3< T >& iMat ) {
    return  TMatrix3x3< T >(
          iValue + iMat[0]
        , iValue + iMat[1]
        , iValue + iMat[2]
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T > operator+( const TMatrix3x3< T >& iMat, T iValue ) {
    return  TMatrix3x3< T >(
          iMat[0] + iValue
        , iMat[1] + iValue
        , iMat[2] + iValue
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix3x3< T > operator+( const TMatrix3x3< T >& iMat, const TMatrix3x3< T >& iOther ) {
    return  TMatrix3x3< T >(
          iMat[0] + iOther[0]
        , iMat[1] + iOther[1]
        , iMat[2] + iOther[2]
