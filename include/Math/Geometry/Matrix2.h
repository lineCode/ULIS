...
// Other Operators
template< typename T >
ULIS_MATRIX_FUNC TMatrix2x2< T >::tColumn& TMatrix2x2< T >::operator[]( int iIndex ) {
    ULIS_ASSERT( iIndex >= 0 && iIndex < 2, "Bad Index" );
    return  mCols[ iIndex ];
}

template< typename T >
ULIS_MATRIX_FUNC const TMatrix2x2< T >::tColumn& TMatrix2x2< T >::operator[]( int iIndex ) const {
    ULIS_ASSERT( iIndex >= 0 && iIndex < 2, "Bad Index" );
    return  mCols[ iIndex ];
}
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix2x2< T >::tColumn operator*( const TMatrix2x2< T >& iMat, const TMatrix2x2< T >::tRow& iRow ) {
    return  TVector2< T >(
...
template< typename T >
ULIS_MATRIX_FUNC TMatrix2x2< T >::tRow operator*( const TMatrix2x2< T >::tColumn& iColumn, const TMatrix2x2< T >& iMat ) {
    return  TVector2< T >(
