...
struct TVector3
{
    ...
    ULIS3_VECTOR_FUNC TVector3();

    /*! Construct the vector from input value ( both x and y will have value iValue ) */
    ULIS3_VECTOR_FUNC TVector3( T iValue );

    /*! Construct the vector from input values. */
    ULIS3_VECTOR_FUNC TVector3( T iX, T iY, T iZ = 0 );

    // Conversion
    /*! Construct the vector from TVector2. */
    ULIS3_VECTOR_FUNC TVector3( const TVector2< T >& iVec, T iZ = 0 );

    /*! Construct the vector from TVector4. */
    ULIS3_VECTOR_FUNC TVector3( const TVector4< T >& iVec );
    ...
    */
    ...
    ULIS3_VECTOR_FUNC T DotProduct( const TVector3& iOther ) const;

    /*! Return the cross product of the vector */
    ULIS3_VECTOR_FUNC T CrossProduct( const TVector3& iOther ) const;

    /*! Normalize this vector. */
    ULIS3_VECTOR_FUNC const TVector3& Normalize();

    /*! Return the normalized version of this vector. */
    ULIS3_VECTOR_FUNC TVector3 Normalized() const;

    // Comparison operators
    /*! Compare this vector to the other vector for strict equality. */
    ULIS3_VECTOR_FUNC bool operator==( const TVector3& iOther ) const;
    ...
    ULIS3_VECTOR_FUNC TVector3& operator+=(const TVector3& iOther );
...
// Constructors
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T >::TVector3()
    : x( 0 )
    , y( 0 )
    , z( 0 )
{}
...
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T >::TVector3( T iValue )
    : x( iValue )
    , y( iValue )
    , z( iValue )
{}
...
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T >::TVector3( T iX, T iY, T iZ )
    : x( iX )
    , y( iY )
    , z( iZ )
{}
...
template< typename T >
template< typename U >
ULIS3_VECTOR_FUNC TVector3< T >:: TVector3( const TVector3< U >& iOther )
...
// Named Functions
template< typename T >
ULIS3_VECTOR_FUNC T TVector3< T >:: Distance() const {
    return  FMaths::Sqrt( x * x + y * y + z * z );
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector3< T >::DistanceSquared() const {
    return  x * x + y * y + z *z;
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector3< T >::ManhattanDistance() const {
    return  FMaths::Abs( x ) + FMaths::Abs( y ) + FMaths::Abs( z );
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector3< T >::DotProduct( const TVector3& iOther ) const {
    return  x * iOther.x + y * iOther.y + z * iOther.z;
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector3< T >::CrossProduct( const TVector3& iOther ) const {
    return  TVector3< T >(
...
template< typename T >
ULIS3_VECTOR_FUNC const TVector3< T >& TVector3< T >::Normalize() {
    T distance = Distance();
...
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T > TVector3< T >::Normalized() const {
...
// Comparison operators
template< typename T >
ULIS3_VECTOR_FUNC bool TVector3< T >::operator==( const TVector3< T >& iOther ) const {
    return  x == iOther.x && y == iOther.y && z == iOther.z;
}
...
// Unary negative operator
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T > TVector3< T >::operator-() const {
...
// Unary Operators with scalar
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T >& TVector3< T >::operator+=( T iValue ) {
    x += iValue;
    y += iValue;
    z += iValue;
    return  *this;
...
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T >& TVector3< T >::operator+=(const TVector3< T >& iOther ) {
    x += iOther.x;
    y += iOther.y;
    z += iOther.z;
    return  *this;
...
template< typename T >
ULIS3_VECTOR_FUNC TVector3< T >& TVector3< T >::operator/=(const TVector3& iOther ) {
    ULIS3_ASSERT( iOther.x != 0, "Division by zero" );
    ULIS3_ASSERT( iOther.y != 0, "Division by zero" );
    ULIS3_ASSERT( iOther.z != 0, "Division by zero" );
    x /= iOther.x;
    y /= iOther.y;
    z /= iOther.z;
    return  *this;
...
// Other Operators
template< typename T >
ULIS3_VECTOR_FUNC T& TVector3< T >::operator[]( int iIndex ) {
    ULIS3_ASSERT( iIndex >= 0 && iIndex < 3, "Bad Index" );
    return  ( &x )[ iIndex ];
}

template< typename T >
ULIS3_VECTOR_FUNC const T& TVector3< T >::operator[]( int iIndex ) const {
    ULIS3_ASSERT( iIndex >= 0 && iIndex < 3, "Bad Index" );
    return  ( &x )[ iIndex ];
}
...
template< typename T >
ULIS3_VECTOR_FUNC T operator+( T iValue, const TVector3< T >& iVector ) {
    return  TVector3< T >(
          iValue + iVector.x
        , iValue + iVector.y
        , iValue + iVector.z
...
template< typename T >
ULIS3_VECTOR_FUNC T operator/( T iValue, const TVector3< T >& iVector ) {
    ULIS3_ASSERT( iVector.x != 0, "Division by zero" );
    ULIS3_ASSERT( iVector.y != 0, "Division by zero" );
    ULIS3_ASSERT( iVector.z != 0, "Division by zero" );
    return  TVector3< T >(
          iValue / iVector.x
        , iValue / iVector.y
        , iValue / iVector.z
...
template< typename T >
ULIS3_VECTOR_FUNC T operator+( const TVector3< T >& iVector, T iValue ) {
    return  TVector3< T >(
          iVector.x + iValue
        , iVector.y + iValue
        , iVector.z + iValue
...
template< typename T >
ULIS3_VECTOR_FUNC T operator+( const TVector3< T >& iVector, const TVector3< T >& iOther ) {
    return  TVector3< T >(
          iVector.x + iOther.x
        , iVector.y + iOther.y
        , iVector.z + iOther.z
