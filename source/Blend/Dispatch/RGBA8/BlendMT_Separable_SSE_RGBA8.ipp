                           ...
                           , ufloat           iOpacity )
{
    ...
    {
        for( int i = 0; i < iBdpROI.h; ++i )
            iPool->ScheduleJob( InvokeBlendMTProcessScanline_Separable_SSE_RGBA8
                              , src + ( ( iSrcROI.y + i ) * src_bps ) + ( iSrcROI.x * 4 )
                              , bdp + ( ( iBdpROI.y + i ) * bdp_bps ) + ( iBdpROI.x * 4 )
