...
template<> ULIS3_FORCEINLINE Vec8f SeparableCompOpAVXF< BM_MULTIPLY    >( Vec8f iCs, Vec8f iCb, Vec8f iAb, Vec8f iVar ) { return  ComposeAVXF( iCs, iCb, iAb, iVar, BlendMultiplyAVXF( iCs, iCb ) ); }
