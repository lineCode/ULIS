...
:: Rebuild Project
cmake -G "MinGW Makefiles" -DULIS_USE_CONFIG:BOOL=ON -DCMAKE_BUILD_TYPE=Release ../../Source
...
IF EXIST CMakeCache.txt ( del CMakeCache.txt )
:: Rebuild Project
cmake -G "MinGW Makefiles" -DULIS_USE_CONFIG:BOOL=ON -DCMAKE_BUILD_TYPE=Debug ../../Source