...
ULIS2_BLENDSPEC_TEMPLATE_SIG void BlendMono_Separable_C1_SSE4_2_Subpixel( ULIS2_BLENDSPEC_PARAMS_SIG ) {
}

ULIS2_BLENDSPEC_TEMPLATE_SIG void BlendMono_Separable_C1_SSE4_2( ULIS2_BLENDSPEC_PARAMS_SIG ) {
    uint8* xidt;
