...
## Rebuild Project
cmake -G "Sublime Text 2 - Unix Makefiles" -DULIS_USE_CONFIG:BOOL=ON -DCMAKE_BUILD_TYPE=Release -DULIS_EXPLICIT_COMPILER_ID:STRING="GCC" -DULIS_EXPLICIT_HOST_ID:STRING="LINUX" ../../Source
