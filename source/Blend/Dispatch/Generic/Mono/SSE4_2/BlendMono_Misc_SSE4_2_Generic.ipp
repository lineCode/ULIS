...
*__________________
*
* @file         BlendMono_Misc_SSE4_2_Generic.ipp
...
void BlendMono_Misc_SSE4_2_Subpixel( const FBlock* iSource, FBlock* iBackdrop, const FRect& iSrcROI, const FRect& iBdpROI, const glm::vec2& iSubpixelComponent, ufloat iOpacity, const FPerf& iPerf ) {
    uint8* xidt;
        ...
        case BM_BAYERDITHER8x8: {
            ...
            for( tSize y = 0; y < roi_w; ++y ) {
                ...
                for( tSize x = 0; x < roi_h; ++x ) {
                    ...
                    const float bayerEl = 0.f; /*gBayer8x8Matrix[ bayerY ][ bayerX ];*/
...
template< typename T, eBlendingMode _BM, eAlphaMode _AM >
void BlendMono_Misc_SSE4_2( const FBlock* iSource, FBlock* iBackdrop, const FRect& iSrcROI, const FRect& iBdpROI, const glm::vec2& iSubpixelComponent, ufloat iOpacity, const FPerf& iPerf ) {
    uint8* xidt;
    uint8 bpc, ncc, hea, spp, bpp, aid;
    tSize roi_w, roi_h, src_bps, bdp_bps, src_jmp, bdp_jmp;
    XBuildBlendParams( iBdpROI, iSource, iBackdrop, &bpc, &ncc, &hea, &spp, &bpp, &aid, &xidt, &roi_w, &roi_h, &src_bps, &bdp_bps, &src_jmp, &bdp_jmp );
...
ULIS2_DELETE_COMP_OP_INSTANCIATION( ULIS2_FOR_ALL_NONSEPARABLE_BM_DO, BlendMono_Misc_SSE4_2 )
ULIS2_DELETE_COMP_OP_INSTANCIATION( ULIS2_FOR_ALL_NONSEPARABLE_BM_DO, BlendMono_Misc_SSE4_2_Subpixel )
ULIS2_DELETE_COMP_OP_INSTANCIATION( ULIS2_FOR_ALL_SEPARABLE_BM_DO, BlendMono_Misc_SSE4_2 )
ULIS2_DELETE_COMP_OP_INSTANCIATION( ULIS2_FOR_ALL_SEPARABLE_BM_DO, BlendMono_Misc_SSE4_2_Subpixel )
