...
#define ULIS_DECLARE_STATIC_BLOCK_SPEC( i ) static constexpr const int i = __LINE__; template<> struct TBlock_Spec< i > { static constexpr const char* m = #i; }; typedef TBlock< i > F##i;
