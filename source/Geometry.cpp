...
{
    x1 = FMaths::Min( iOBB.m00.x, FMaths::Min3( iOBB.m01.x, iOBB.m11.x, iOBB.m10.x ) );
    y1 = FMaths::Min( iOBB.m00.y, FMaths::Min3( iOBB.m01.y, iOBB.m11.y, iOBB.m10.y ) );
    x2 = FMaths::Max( iOBB.m00.x, FMaths::Max3( iOBB.m01.x, iOBB.m11.x, iOBB.m10.x ) );
    y2 = FMaths::Max( iOBB.m00.y, FMaths::Max3( iOBB.m01.y, iOBB.m11.y, iOBB.m10.y ) );
}
...
FTransformAABB::SetPoints( const std::vector< glm::vec2 >& points )
{
    ...
    x1 = FMaths::Min( points[0].x, FMaths::Min3( points[1].x, points[2].x, points[3].x ) );
    y1 = FMaths::Min( points[0].y, FMaths::Min3( points[1].y, points[2].y, points[3].y ) );
    x2 = FMaths::Max( points[0].x, FMaths::Max3( points[1].x, points[2].x, points[3].x ) );
    y2 = FMaths::Max( points[0].y, FMaths::Max3( points[1].y, points[2].y, points[3].y ) );
}
...
{
    assert( points.size() == 4 );
    x1 = FMaths::RoundAwayFromZero( FMaths::Min( points[0].x, FMaths::Min3( points[1].x, points[2].x, points[3].x ) ) );
    y1 = FMaths::RoundAwayFromZero( FMaths::Min( points[0].y, FMaths::Min3( points[1].y, points[2].y, points[3].y ) ) );
    x2 = FMaths::RoundAwayFromZero( FMaths::Max( points[0].x, FMaths::Max3( points[1].x, points[2].x, points[3].x ) ) );
    y2 = FMaths::RoundAwayFromZero( FMaths::Max( points[0].y, FMaths::Max3( points[1].y, points[2].y, points[3].y ) ) );
}
