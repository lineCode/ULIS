...
void mt_blend_normal( ::ULIS::FBlockdoubleCMYKhasAlphaACMYKnormalized* iBlockA, ::ULIS::FBlockdoubleCMYKhasAlphaACMYKnormalized* iBlockB )
{
    ::ULIS::FBlendingContext::Blend( iBlockB, iBlockA, ::ULIS::eBlendingMode::kNormal, 0.5f );
}
