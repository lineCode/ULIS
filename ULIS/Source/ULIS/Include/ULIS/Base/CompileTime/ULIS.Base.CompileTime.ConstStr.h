...
struct const_str
{
    ...
    constexpr const uint32 CRC32() const { return ULIS_COMPILE_TIME_CRC32_STR( s ); }
    ...
    template< int L, typename T, T... Nums > static constexpr const const_str< L > make_const_str_append_impl(  const char* strA, const char* strB, ::ULIS::_CT::integer_sequence< T, Nums... > ) { return { const_str_impl_getchar_append( strA, strB, ct_strlen( strA ), Nums ) ..., '\0' }; }
...
// Construction
template< int N, typename T, T... Nums > static constexpr const const_str< N > make_const_str_impl( const char* str, ::ULIS::_CT::integer_sequence< T, Nums... > ) { return { str[Nums] ... }; }
template< int N > static constexpr const const_str< N > make_const_str( const char (&str)[N] ) { return make_const_str_impl< N >( str, ::ULIS::_CT::make_integer_sequence< int, N >() ); }
#define CONST_STR( i ) ::ULIS::_CT::make_const_str( i )
