...
struct TVector2
{
    ...
    ULIS3_VECTOR_FUNC TVector2();

    /*! Construct the vector from input value ( both x and y will have value iValue ) */
    ULIS3_VECTOR_FUNC TVector2( T iValue );

    /*! Construct the vector from input values. */
    ULIS3_VECTOR_FUNC TVector2( T iX, T iY );



    // Conversion
    /*! Construct the vector from TVector3. */
    ULIS3_VECTOR_FUNC TVector2( const TVector3< T >& iVec );

    /*! Construct the vector from TVector4. */
    ULIS3_VECTOR_FUNC TVector2( const TVector4< T >& iVec );

    /*! Construct the vector from input vector of any convertible type. */
    template< typename U >
    ULIS3_VECTOR_FUNC TVector2( const TVector2< U >& iOther );
    ...
    */
    ...
    ULIS3_VECTOR_FUNC T DotProduct( const TVector2& iOther ) const;

    /*! Normalize this vector. */
    ULIS3_VECTOR_FUNC const TVector2& Normalize();

    /*! Return the normalized version of this vector. */
    ULIS3_VECTOR_FUNC TVector2 Normalized() const;



    // Comparison operators
    /*! Compare this vector to the other vector for strict equality. */
    ULIS3_VECTOR_FUNC bool operator==( const TVector2& iOther ) const;
    ...
    ULIS3_VECTOR_FUNC TVector2& operator+=( T iValue );
    ...
    ULIS3_VECTOR_FUNC TVector2& operator+=(const TVector2& iOther );
...
// Constructors
template< typename T >
ULIS3_VECTOR_FUNC TVector2< T >::TVector2()
    : x( 0 )
    , y( 0 )
{}

template< typename T >
ULIS3_VECTOR_FUNC TVector2< T >::TVector2( T iValue )
    : x( iValue )
    , y( iValue )
{}

template< typename T >
ULIS3_VECTOR_FUNC TVector2< T >::TVector2( T iX, T iY )
    : x( iX )
    , y( iY )
{}
...
template< typename T >
template< typename U >
ULIS3_VECTOR_FUNC TVector2< T >:: TVector2( const TVector2< U >& iOther )
...
// Named Functions
template< typename T >
ULIS3_VECTOR_FUNC T TVector2< T >:: Distance() const {
    return  FMaths::Sqrt( x * x + y * y );
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector2< T >::DistanceSquared() const {
    return  x * x + y * y;
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector2< T >::ManhattanDistance() const {
    return  FMaths::Abs( x ) + FMaths::Abs( y );
}

template< typename T >
ULIS3_VECTOR_FUNC T TVector2< T >::DotProduct( const TVector2& iOther ) const {
    return  x * iOther.x + y * iOther.y;
}

template< typename T >
ULIS3_VECTOR_FUNC const TVector2< T >& TVector2< T >::Normalize() {
    T distance = Distance();
...
template< typename T >
ULIS3_VECTOR_FUNC TVector2< T > TVector2< T >::Normalized() const {
...
// Comparison operators
template< typename T >
ULIS3_VECTOR_FUNC bool TVector2< T >::operator==( const TVector2< T >& iOther ) const {
    return  x == iOther.x && y == iOther.y;
}
...
// Unary negative operator
template< typename T >
ULIS3_VECTOR_FUNC TVector2< T > TVector2< T >::operator-() const {
...
// Unary Operators with scalar
template< typename T >
ULIS3_VECTOR_FUNC TVector2< T >& TVector2< T >::operator+=( T iValue ) {
    x += iValue;
    y += iValue;
    return  *this;
}
...
template< typename T >
ULIS3_VECTOR_FUNC TVector2< T >& TVector2< T >::operator+=(const TVector2< T >& iOther ) {
    x += iOther.x;
    y += iOther.y;
    return  *this;
}
...
template< typename T >
ULIS3_VECTOR_FUNC TVector2< T >& TVector2< T >::operator/=(const TVector2& iOther ) {
...
// Other Operators
template< typename T >
ULIS3_VECTOR_FUNC T& TVector2< T >::operator[]( int iIndex ) {
    ULIS3_ASSERT( iIndex >= 0 && iIndex < 2, "Bad Index" );
    return  ( &x )[ iIndex ];
}

template< typename T >
ULIS3_VECTOR_FUNC const T& TVector2< T >::operator[]( int iIndex ) const {
    ULIS3_ASSERT( iIndex >= 0 && iIndex < 2, "Bad Index" );
    return  ( &x )[ iIndex ];
}
...
template< typename T >
ULIS3_VECTOR_FUNC T operator+( T iValue, const TVector2< T >& iVector ) {
    return  TVector2< T >(
          iValue + iVector.x
        , iValue + iVector.y
    );
...
template< typename T >
ULIS3_VECTOR_FUNC T operator+( const TVector2< T >& iVector, T iValue ) {
    return  TVector2< T >(
          iVector.x + iValue
        , iVector.y + iValue
    );
...
template< typename T >
ULIS3_VECTOR_FUNC T operator+( const TVector2< T >& iVector, const TVector2< T >& iOther ) {
    return  TVector2< T >(
          iVector.x + iOther.x
        , iVector.y + iOther.y
    );
