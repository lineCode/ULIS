...
int clear( int argc, char *argv[] )
{
    ...
    std::cout << "OP:   " << "clear"    << std::endl;
        ...
        print_short_op( argv[1], ::ULIS::BlockSpec( fmt )._ss, argv[3], argv[4], argv[5], argv[6], "" );
    #endif // ULIS_PROFILER_VERBOSE
...
int blend( int argc, char *argv[] )
{
    ...
    ::ULIS::uint32  mode = std::atoi( std::string( argv[7] ).c_str() );
        ...
        print_short_op( argv[1], ::ULIS::BlockSpec( fmt )._ss, argv[3], argv[4], argv[5], argv[6], ::ULIS::kwBlendingMode[mode] );
    #endif // ULIS_PROFILER_VERBOSE
